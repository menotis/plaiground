...
없으면 저장소의 var/workspaces/local/.telemetry — 호스트에서 저장소를 그대로 쓰는 개발 환경용.
...
TELEMETRY_DIR = Path(os.environ.get("PLAIGROUND_TELEMETRY_DIR") or REPO_ROOT / "var" / "workspaces" / "local" / ".telemetry")
