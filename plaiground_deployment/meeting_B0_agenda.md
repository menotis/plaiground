...
> **2026-09-22: 회의 대신 문서로 결정함.** 결정 내용은 [decisions.md](decisions.md), 스키마는 `supabase/migrations/`, 협업 규칙은 [../CONTRIBUTING.md](../CONTRIBUTING.md). 이 안건 중 남은 것은 **1번 초대 확인**과 **Stage C 시연 날짜**뿐이다. 두 사람이 만날 때 그 둘만 확인한다.
