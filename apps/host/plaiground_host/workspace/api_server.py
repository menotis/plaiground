"""
api_server.py — 환경 세팅·모델 카탈로그·학습 시각화 API를 제공하는 기본 핸들러.
...
엔드포인트:
  ...
  그 외 경로                      apps/web/dist 정적 파일 (없으면 안내 메시지)
...
from ..paths import TELEMETRY_DIR, WEB_DIST
...
def _read_env() -> dict[str, str]:
    """마법사가 기록한 workspace/.env 값 (없으면 빈 dict)."""
